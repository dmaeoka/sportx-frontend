...
describe('useBettingLogic composable', () => {
	let selectedBets: ReturnType<typeof ref>;
	let betAmount: ReturnType<typeof ref>;
	let bettingLogic: ReturnType<typeof useBettingLogic>;
...
describe('useSuccessMessage composable', () => {
	let successMessage: ReturnType<typeof useSuccessMessage>;
...
describe('useEventHelpers composable', () => {
	let eventHelpers: ReturnType<typeof useEventHelpers>;
